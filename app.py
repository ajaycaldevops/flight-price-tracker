...
def create_app():
    ...
    def index():
        if request.method == "POST":
            ...
            if not departure_date_from or not departure_date_to:
                errors.append("Please provide a travel date range.")
            ...
            try:
                ...
                if d_from > d_to:
                    errors.append("Departure 'from' date must be before or equal to 'to' date.")
            ...
            return redirect(url_for("success", search_id=pref.id))
    ...
    def success(search_id):
        ...
        return render_template("success.html", pref=pref)
